		...
		<div class="container">
			<div class="row fullscreen d-flex align-items-center">
				<div class="banner-content col-lg-6 col-md-12 justify-content-center ">
					<div class="me wow fadeInDown" data-wow-duration="1s" data-wow-delay="1.2s">It's </div>
					<h1 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="1.7s">ME</h1>
					<div class="designation mb-50 wow fadeInUp" data-wow-duration="1s" data-wow-delay="2.1s">
						Student,THE Creative
						<span class="designer">Free Thinker</span>
						and Web Developer
						
					</div>
					<a href="info.htm" class="primary-btn" data-text="Know More">
						<span>R</span>
						<span>e</span>
						<span>a</span>
						<span>d</span>
				...
				<div class="banner-img col-lg-6 col-md-6 align-self-end">
					<img class="img-fluid" src="img/me1.jpeg" alt="">
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row align-items-center justify-content-between">
				...
				<div class="col-lg-5 col-md-12 about-right">
					...
					<div class="mb-50 wow fadeIn" data-wow-duration=".8s">
						<p><span></span> An honest & hardworking individual, who is completing his BSc in Engineering, achieved excellent grades. Eventual career goal is to become a fully-qualified and experienced engineer.  <br> 

						<p>I am a Student,Web Developer who is very much interested in Traveling</p> 
						<p> <br>
...
<br></p>
					...
					<a href="info.htm" class="primary-btn white" data-text="More Info">
						<span>M</span>
						<span>o</span>
						<span>r</span>
						<span>e</span>
					...
					<a href="info.htm" class="primary-btn" data-text="Resume">
						<span>R</span>
						<span>e</span>
						<span>s</span>
						<span>u</span>
				...
				<div class="col-lg-6">
					<div class="filters">
						<ul>
							...
							<li data-filter=".branding">Machine Learning</li>
							<li data-filter=".creative">Wireless Network</li>
				...
				<div class="row grid">
					<div class="single-work col-lg-4 col-md-6 col-sm-12 all creative wow fadeInUp" data-wow-duration="2s">
						<div class="relative">
							<div class="thumb">
								...
								<img class="image img-fluid" src="img/work/new.jpg" alt="">
							</div>
							<div class="middle">
					...
					<div class="single-work col-lg-4 col-md-6 col-sm-12 all web-design branding wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="img/work/big.jpg" alt="">
							</div>
							<div class="middle">
								<h4>Big Data</h4>
					...
					<div class="single-work col-lg-4 col-md-6 col-sm-12 all branding web-design wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.4s">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="img/work/ai.jpg" alt="">
							</div>
							<div class="middle">
								<h4>AI </h4>
		...
		<div class="container">
			<div class="row d-flex">
				<div class="col-lg-12">
					<div class="section-title">
						<h2>Works History</h2>
						<p> Though our experience is not enought about web develpoing advertising and tourism management as well as social worker but we have done some tremendous work in this following sector.
						Although we are not yet satisfied about our job ,which we have done ,we want to exlore more and more</p>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-3 col-md-6">
					<div class="single-service wow fadeInUp" data-wow-duration="1s">
						...
						<p>Try to Hardwork and Creative place</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="single-service wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
						<span class="lnr lnr-laptop-phone"></span>
						<h4><span>Travel </span> guide
						</h4>
						<p>If you can ,join us!</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="single-service wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
						<span class="lnr lnr-database"></span>
						<h4><span>Advertising manager</span> manager
						</h4>
						<p>An advertising manager is someone who plans and directs the promotional and advertising
						 campaigns of companies in order to generate interest in a product or service</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
	...
	<section class="contact-area section-gap">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="contact-title">
						<h2>Contact US</h2>
						<p>In case of emergency or if you need to contact us fell free to contact any 
						of the following number and send the mail.</p>
					</div>
				</div>
			</div>
			...
			<div class="row mt-80">
				...
				<div class="col-lg-4 col-md-4">
					<div class="contact-box">
						<h4>Shahruk Hossen</h4>
						<h4>shahrukhossen@gmai.com</h4>
						<h4>+88 01722928237</h4>
					</div>
				</div>
			...
			<div class="col-lg-12 text-center">
					<a href="portfolio.php" class="primary-btn mt-50" data-text="Instant Contact">
						<span>C</span>
						<span>o</span>
						<span>n</span>
						<span>t</span>
